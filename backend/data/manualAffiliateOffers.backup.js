...
const MANUAL_OFFER_VERIFIED_AT = Object.freeze({
    'mercadolivre-affiliate-001': '2026-08-14',
    'mercadolivre-affiliate-002': '2026-08-14',
    'mercadolivre-affiliate-003': '2026-08-14',
    'mercadolivre-affiliate-004': '2026-08-14',
    'mercadolivre-affiliate-005': '2026-08-14',
    'mercadolivre-affiliate-006': '2026-08-14',
    'mercadolivre-affiliate-007': '2026-08-14',
    'mercadolivre-affiliate-008': '2026-08-14',
    'mercadolivre-affiliate-009': '2026-08-14',
    'mercadolivre-affiliate-010': '2026-08-14',
    'mercadolivre-affiliate-011': '2026-08-14',
    'mercadolivre-affiliate-012': '2026-08-14',
    'mercadolivre-affiliate-013': '2026-08-14',
    'mercadolivre-affiliate-014': '2026-08-14',
    'mercadolivre-affiliate-015': '2026-08-14',
    'mercadolivre-affiliate-016': '2026-08-14',
    'mercadolivre-affiliate-017': '2026-08-14',
    'mercadolivre-affiliate-018': '2026-08-14',
    'mercadolivre-affiliate-019': '2026-08-14',
    'mercadolivre-affiliate-020': '2026-08-14',
    'mercadolivre-affiliate-021': '2026-08-14',
    'mercadolivre-affiliate-022': '2026-08-14',
    'mercadolivre-affiliate-023': '2026-08-14',
    'mercadolivre-affiliate-024': '2026-08-14',
    'mercadolivre-affiliate-025': '2026-08-14',
    'mercadolivre-affiliate-026': '2026-08-14',
    'mercadolivre-affiliate-027': '2026-08-14',
    'mercadolivre-affiliate-028': '2026-08-14',
    'mercadolivre-affiliate-029': '2026-08-14',
    'mercadolivre-affiliate-030': '2026-08-14'
});

const MANUAL_OFFER_REFERENCE_DATA = Object.freeze({
    'mercadolivre-affiliate-001': { referencePrice: null, referencePriceCapturedAt: null },
    'mercadolivre-affiliate-002': { referencePrice: null, referencePriceCapturedAt: null },
    'mercadolivre-affiliate-003': { referencePrice: null, referencePriceCapturedAt: null },
    'mercadolivre-affiliate-004': { referencePrice: null, referencePriceCapturedAt: null },
    'mercadolivre-affiliate-005': { referencePrice: null, referencePriceCapturedAt: null },
    'mercadolivre-affiliate-006': { referencePrice: null, referencePriceCapturedAt: null },
    'mercadolivre-affiliate-007': { referencePrice: null, referencePriceCapturedAt: null },
    'mercadolivre-affiliate-008': { referencePrice: null, referencePriceCapturedAt: null },
    'mercadolivre-affiliate-009': { referencePrice: null, referencePriceCapturedAt: null },
    'mercadolivre-affiliate-010': { referencePrice: null, referencePriceCapturedAt: null },
    'mercadolivre-affiliate-011': { referencePrice: null, referencePriceCapturedAt: null },
    'mercadolivre-affiliate-012': { referencePrice: null, referencePriceCapturedAt: null },
    'mercadolivre-affiliate-013': { referencePrice: null, referencePriceCapturedAt: null },
    'mercadolivre-affiliate-014': { referencePrice: null, referencePriceCapturedAt: null },
    'mercadolivre-affiliate-015': { referencePrice: null, referencePriceCapturedAt: null },
    'mercadolivre-affiliate-016': { referencePrice: null, referencePriceCapturedAt: null },
    'mercadolivre-affiliate-017': { referencePrice: null, referencePriceCapturedAt: null },
    'mercadolivre-affiliate-018': { referencePrice: null, referencePriceCapturedAt: null },
    'mercadolivre-affiliate-019': { referencePrice: null, referencePriceCapturedAt: null },
    'mercadolivre-affiliate-020': { referencePrice: null, referencePriceCapturedAt: null },
    'mercadolivre-affiliate-021': { referencePrice: null, referencePriceCapturedAt: null },
    'mercadolivre-affiliate-022': { referencePrice: null, referencePriceCapturedAt: null },
    'mercadolivre-affiliate-023': { referencePrice: null, referencePriceCapturedAt: null },
    'mercadolivre-affiliate-024': { referencePrice: null, referencePriceCapturedAt: null },
    'mercadolivre-affiliate-025': { referencePrice: null, referencePriceCapturedAt: null },
    'mercadolivre-affiliate-026': { referencePrice: null, referencePriceCapturedAt: null },
    'mercadolivre-affiliate-027': { referencePrice: null, referencePriceCapturedAt: null },
    'mercadolivre-affiliate-028': { referencePrice: null, referencePriceCapturedAt: null },
    'mercadolivre-affiliate-029': { referencePrice: null, referencePriceCapturedAt: null },
    'mercadolivre-affiliate-030': { referencePrice: null, referencePriceCapturedAt: null }
});

const manualAffiliateOffers = Object.freeze(
    MERCADO_LIVRE_AFFILIATE_URLS.map((affiliateUrl, index) => {
        const id = `mercadolivre-affiliate-${String(index + 1).padStart(3, '0')}`;
        return Object.freeze({
            ...
            referencePrice: MANUAL_OFFER_REFERENCE_DATA[id].referencePrice,
            referencePriceCapturedAt: MANUAL_OFFER_REFERENCE_DATA[id].referencePriceCapturedAt,
            oldPrice: null,
            discount: null,
            ...
            lastVerifiedAt: MANUAL_OFFER_VERIFIED_AT[id]
        });
    })
);
...
function withUpdatedLastVerifiedAt(offerId, lastVerifiedAt) {
    if (parseFullIsoTimestamp(lastVerifiedAt) === null) {
        throw new TypeError('lastVerifiedAt deve ser um timestamp ISO completo com fuso horário.');
    }

    const offer = manualAffiliateOffers.find(item => item.id === offerId);
    if (!offer) throw new RangeError('Oferta manual não encontrada.');
